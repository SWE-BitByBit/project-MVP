"""
Test di integrazione: S3ResourcesRepository + S3 (emulato con moto).

Verifica che il repository legga e mappi correttamente i dati
da un bucket S3 simulato, incluso il caso di file assente.
"""
...
class TestS3ResourcesRepository:
    """Test di integrazione per il repository S3ResourcesRepository."""
