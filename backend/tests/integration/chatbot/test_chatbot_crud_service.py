"""
Test di integrazione: ChatbotCRUDService + DynamoChatAdapter + DynamoDB (emulato con moto).

Verifica che le operazioni CRUD sulle chat funzionino correttamente
attraverso l'intera catena Service -> Adapter -> DynamoDB.
"""
