"""
Test di integrazione: DynamoDmsAdapter + DynamoDB (emulato con moto).

Verifica che le operazioni CRUD sulle impostazioni del Dead Man's Switch
funzionino correttamente attraverso la catena Adapter -> DynamoDB.
"""
