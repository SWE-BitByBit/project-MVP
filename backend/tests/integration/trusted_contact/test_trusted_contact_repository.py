"""
Test di integrazione: DynamoTrustedContactAdapter + DynamoDB (emulato con moto).

Verifica che le operazioni CRUD sui contatti fidati funzionino correttamente
attraverso la catena Adapter -> DynamoDB.
"""
