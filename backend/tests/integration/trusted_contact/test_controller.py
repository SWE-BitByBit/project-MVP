"""
Test di integrazione: TrustedContactController + DynamoDB + SES (emulati con moto).

Verifica che l'intero flusso del controller (DMS CRUD, contatti fidati,
alert SOS, evento schedulato) funzioni correttamente con tutti gli adapter
collegati ai servizi AWS simulati.
"""
