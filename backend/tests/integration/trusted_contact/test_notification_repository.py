"""
Test di integrazione: SesNotificationAdapter + SES (emulato con moto).

Verifica che l'invio di email tramite SES funzioni correttamente
attraverso la catena Adapter -> Amazon SES simulato.
"""
