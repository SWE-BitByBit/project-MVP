"""
Test di integrazione: Lambda Handler trusted_contact + DynamoDB + SES (emulati con moto).

Verifica che il lambda_handler risponda correttamente agli eventi HTTP
attraverso l'intera catena Handler -> Controller -> Services -> Adapters -> AWS simulati.
"""
